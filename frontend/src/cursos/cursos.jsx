...
import { create, update, remove } from './cursosActions'

import List from './cursosList'
import Form from './cursosForm'
...
class Cursos extends Component {
    ...
    render() {
        return (
            <div>
                <ContentHeader title="Cursos" small="Cadastro" />
                <Content>
                    <Tabs>
                        <TabsHeader>
...
export default connect(null, mapDistpatchToProps)(Cursos)